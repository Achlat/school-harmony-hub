...
export default function StaffPage() {
  ...
  const columns = [
    {
      key: 'name', header: 'Nom',
      render: (s: Staff) => <span className="font-medium text-card-foreground">{s.lastName} {s.firstName}</span>,
    },
    {
    ...
    {
      key: 'subjects', header: 'Matières', className: 'hidden lg:table-cell',
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>{editItem ? 'Modifier' : 'Ajouter un membre'}</DialogTitle>
          </DialogHeader>
